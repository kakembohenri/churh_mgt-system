    ...
    ?>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_log=mysqli_query($conn,"select * from activity_log where church_id='$church_id'");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_log.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
                              		...
                              		<?php
										$query = mysqli_query($conn,"select * from activity_log where church_id='$church_id' order by timestamp DESC")or die(mysqli_error($conn));
