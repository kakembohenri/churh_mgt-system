...
<?php include('session.php'); ?>
    <body>
	<?php include('plans/standard_plan.php'); ?>
	<?php include('plans/expiry.php'); ?>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_members=mysqli_query($conn,"SELECT * FROm  event WHERE church_id='$church_id' and DATE_ADD(STR_TO_DATE(Date, '%Y-%m-%d'), INTERVAL YEAR(CURDATE())-YEAR(STR_TO_DATE(Date, '%Y-%m-%d')) YEAR) 
...
FROm  event
WHERE church_id='$church_id' and DATE_ADD(STR_TO_DATE(Date, '%Y-%m-%d'), INTERVAL YEAR(CURDATE())-YEAR(STR_TO_DATE(Date, '%Y-%m-%d')) YEAR) 
