...
$status_message = "Select the checbox if you want to delete ?";
				...
				<div class="row-fluid">
					...
					<div class="empty">
						<div class="alert alert-success alert-dismissable">
							...
							<i class="icon-info-sign"></i> <strong>Note!:</strong><?php echo ($status_message) ?>
						</div>
					</div>

					<?php
					$count_user = mysqli_query($conn, "select * from event ");
							...
							<div class="span12">
								<form action="delete_event.php" method="post">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										<a data-placement="right" title="Click to Delete check item" data-toggle="modal" href="#event_delete" id="delete" class="btn btn-danger" name=""><i class="icon-trash icon-large"> Delete</i></a>
										...
										<tbody>
											<?php
											$user_query = mysqli_query($conn, "select * from event where church_id='$church_id' ") or die(mysqli_error($conn));
