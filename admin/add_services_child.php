...
if (isset($_POST['save'])) {
  ...
  mysqli_query($conn, "insert into service_child (service_name,service_date) values('$service_name','$service_date')") or die('Error: ' . mysqli_error($conn));
...
?>
  <script>
    window.location = "add_child_congrigants.php";
