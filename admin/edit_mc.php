    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_mc_form.php'); ?>		   			
				</div>
				<?php	
	             $count_members=mysqli_query($conn,"select * from mc");
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-user"></i>  Missional communities(s) List</div>
								<div class="muted pull-right">
								Number of mcs <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                            </div>
