...
font-family:"Times New Roman","serif"'><?php echo $row['name']; ?> PCs'</span></b></p>
...
"Times New Roman","serif"'>All PCs' at <?php echo $row['name']; ?><o:p></o:p></span></p>
...
"Times New Roman","serif"'>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  mso-background-themeshade:191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
                                                    <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>FAMILY NAME<o:p></o:p></span></b></p>
                                                </td>
                                                <td width=188 style='width:140.9pt;border:solid windowtext 1.0pt;mso-border-alt:
  solid windowtext .5pt;background:#BFBFBF;mso-background-themecolor:background1;
  mso-background-themeshade:191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>CONTACT<o:p></o:p></span></b></p>
                                                ...
                                                <!-- mysqli FETCH ARRAY-->
                                                <?php
                                                $student_query = mysqli_query($conn, "select * from pc where church_id='$church_id'") or die(mysqli_error($conn));
  ...
  padding:0in 5.4pt 0in 5.4pt'>
                                                    <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['familyname']; ?><o:p></o:p></span></p>
                                                </td>
