		...
		<div class="row-fluid">
			...
			<div class="span6" id="">
				<div class="row-fluid">
					...
					<?php
					$count_user = mysqli_query($conn, "SELECT * from admin join role on role.roleId=admin.roleId");
							...
							<div class="span12">
								<form action="delete_users.php" method="post">
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
											<?php
											$user_query = mysqli_query($conn, "SELECT * from admin join role on role.roleId=admin.roleId") or die(mysqli_error($conn));
